...
class BFS(SearchAlgorithm):
    ...
    """
        ...
        ----------
        problem : Problem
            The problem to be solved, which must provide methods get_initial_state(), get_successors(state), and goat_test(state).
        Returns
        -------
        SearchResult
    ...
    def search(self, problem):
        ...
        if problem.goat_test(root.state): # if the root is the goal state
